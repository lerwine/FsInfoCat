...
namespace FsInfoCat
{
    ...
    public sealed class ConfigureServicesHandlerAttribute : Attribute
    {
        ...
        public static IEnumerable<MethodInfo> GetHandlers(Type type)
        {
            ...
            return type.GetMethods(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static)
                .Select(m => (Method: m, Attribute: m.GetCustomAttribute<ConfigureServicesHandlerAttribute>()))
                .Where(t => !(t.Attribute is null) && t.Method.ReturnType.Equals(r) && (parameters = t.Method.GetParameters()).Length == 1 &&
