...
namespace FsInfoCat.Desktop.Local.ImagePropertySets
{
    public class ListingViewModel : ListingViewModel<ImagePropertiesListItem, ListItemViewModel, ListingViewModel.ListOptions>, INotifyNavigatedTo
    {
        ...
        protected override ListItemViewModel CreateItemViewModel([DisallowNull] ImagePropertiesListItem entity)
        {
            throw new NotImplementedException();
        }
        ...
        protected override Task<int> DeleteEntityFromDbContextAsync([DisallowNull] ImagePropertiesListItem entity, [DisallowNull] LocalDbContext dbContext, [DisallowNull] IWindowsStatusListener statusListener)
        {
            throw new NotImplementedException();
        }
