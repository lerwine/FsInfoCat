...
namespace FsInfoCat.Desktop.Local.DRMPropertySets
{
    public class ListingViewModel : ListingViewModel<DRMPropertiesListItem, ListItemViewModel, ListingViewModel.ListOptions>, INotifyNavigatedTo
    {
        ...
        protected override async Task<int> DeleteEntityFromDbContextAsync([DisallowNull] DRMPropertiesListItem entity, [DisallowNull] LocalDbContext dbContext, [DisallowNull] IWindowsStatusListener statusListener)
        {
            throw new NotImplementedException();
        }
