...
namespace FsInfoCat.Desktop.Local.MediaPropertySets
{
    public class ListingViewModel : ListingViewModel<MediaPropertiesListItem, ListItemViewModel, ListingViewModel.ListOptions>, INotifyNavigatedTo
    {
        ...
        protected override async Task<int> DeleteEntityFromDbContextAsync([DisallowNull] MediaPropertiesListItem entity, [DisallowNull] LocalDbContext dbContext, [DisallowNull] IWindowsStatusListener statusListener)
        {
            throw new NotImplementedException();
        }
