...
namespace FsInfoCat.Desktop.Local.RecordedTVPropertySets
{
    public class ListingViewModel : ListingViewModel<RecordedTVPropertiesListItem, ListItemViewModel, ListingViewModel.ListOptions>, INotifyNavigatedTo
    {
        ...
        protected override ListItemViewModel CreateItemViewModel([DisallowNull] RecordedTVPropertiesListItem entity)
        {
            throw new NotImplementedException();
        }
        ...
        protected override Task<int> DeleteEntityFromDbContextAsync([DisallowNull] RecordedTVPropertiesListItem entity, [DisallowNull] LocalDbContext dbContext, [DisallowNull] IWindowsStatusListener statusListener)
        {
            throw new NotImplementedException();
        }
