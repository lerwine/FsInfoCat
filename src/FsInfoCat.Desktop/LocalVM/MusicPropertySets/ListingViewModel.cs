...
namespace FsInfoCat.Desktop.LocalVM.MusicPropertySets
{
    public class ListingViewModel : ListingViewModel<MusicPropertiesListItem, ListItemViewModel, bool?>, INotifyNavigatedTo
    {
        ...
        protected override async Task<int> DeleteEntityFromDbContextAsync([DisallowNull] MusicPropertiesListItem entity, [DisallowNull] LocalDbContext dbContext,
            [DisallowNull] IWindowsStatusListener statusListener)
        {
            ...
            if (target is null)
                return 0;
            _ = dbContext.MusicPropertySets.Remove(target);
