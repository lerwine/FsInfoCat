...
namespace FsInfoCat.Desktop.LocalVM.SummaryPropertySets
{
    public class ListingViewModel : ListingViewModel<SummaryPropertiesListItem, ListItemViewModel, bool?>, INotifyNavigatedTo
    {
        ...
        protected override async Task<int> DeleteEntityFromDbContextAsync([DisallowNull] SummaryPropertiesListItem entity, [DisallowNull] LocalDbContext dbContext,
