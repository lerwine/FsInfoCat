...
namespace FsInfoCat.Desktop.ViewModel
{
    public class RecordedTVPropertySetDetailsViewModel<TEntity, TFileEntity, TFileItem> : RecordedTVPropertiesRowViewModel<TEntity>, IItemFunctionViewModel<TEntity>
        where TEntity : Model.DbEntity, Model.IRecordedTVPropertySet, Model.IRecordedTVProperties
        ...
        where TFileItem : FileWithBinaryPropertiesAndAncestorNamesViewModel<TFileEntity>
    {
        ...
        private static readonly DependencyPropertyKey FilesPropertyKey = ColumnPropertyBuilder<ObservableCollection<TFileItem>, RecordedTVPropertySetDetailsViewModel<TEntity, TFileEntity, TFileItem>>
            .RegisterEntityMapped<TEntity>(nameof(Model.IRecordedTVPropertySet.Files))
            .AsReadOnly();
