...
namespace FsInfoCat.Desktop.ViewModel
{
        ...
        where TEntity : DbEntity, IAudioPropertiesListItem
    {
        ...
        private static readonly DependencyPropertyKey ExistingFileCountPropertyKey = DependencyProperty.RegisterReadOnly(nameof(ExistingFileCount), typeof(long), typeof(AudioPropertiesListItemViewModel<TEntity>),
