...
namespace FsInfoCat.Desktop.ViewModel.AsyncOps
{
    ...
    public partial class AsyncActionOpViewModel<TState> : AsyncOpManagerViewModel<TState, Task, AsyncActionOpViewModel<TState>, AsyncActionOpViewModel<TState>.StatusListenerImpl>.AsyncOpViewModel
    {
        ...
        /// </summary>
        /// <returns>The <see cref="StatusListenerImpl"/> that can be used to monitor for cancellation and to update the current <see cref="AsyncActionOpViewModel{TState}"/>.</returns>
        ...
        /// </summary>
        /// <returns>The <see cref="Task"/> that implements the background operation.</returns>
        internal override Task GetTask() => _task;

        private AsyncActionOpViewModel(TState initialState, Func<StatusListenerImpl, Task> createTask)
            : base(initialState)
        {
            _statusListener = new StatusListenerImpl(this);
            _task = createTask(_statusListener);
        ...
        /// <returns>The <see cref="AsyncActionOpViewModel{TState}"/> object representing the status of the background operation.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="operationManager"/> or <paramref name="action"/> was null.</exception>
        public static AsyncActionOpViewModel<TState> AddNew(TState initialState, [DisallowNull] AsyncOpManagerViewModel<TState, Task, AsyncActionOpViewModel<TState>, StatusListenerImpl> operationManager,
    ...
    public partial class AsyncActionOpViewModel : AsyncOpManagerViewModel<object, Task, AsyncActionOpViewModel, AsyncActionOpViewModel.StatusListenerImpl>.AsyncOpViewModel
    {
        ...
        /// Gets the listener that can be used to monitor for cancellation and to update the current view model item.
        /// </summary>
        /// <returns>The <see cref="StatusListenerImpl"/> that can be used to monitor for cancellation and to update the current <see cref="AsyncActionOpViewModel"/>.</returns>
        internal override StatusListenerImpl GetStatusListener() => _statusListener;
        ...
        private AsyncActionOpViewModel(Func<StatusListenerImpl, Task> createTask)
            : base(null)
        {
            _statusListener = new StatusListenerImpl(this);
            _task = createTask(_statusListener);
        ...
        /// <returns>A <see cref="AsyncActionOpViewModel"/> representing the status of the background operation.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="operationManager"/> or <paramref name="action"/> was null.</exception>
        public static AsyncActionOpViewModel AddNew([DisallowNull] AsyncOpManagerViewModel<Task, AsyncActionOpViewModel, StatusListenerImpl> operationManager,
