...
namespace FsInfoCat.Desktop.ViewModel.Local
{
    ...
    public class SharedTagDefinitionsPageVM : DbEntityListingPageVM<SharedTagDefinitionListItem, SharedTagDefinitionItemVM>
    {
        ...
        protected virtual void OnSelectedItemPropertyChanged(SharedTagDefinitionItemVM oldValue, SharedTagDefinitionItemVM newValue)
        {
        ...
        protected override bool ShowModalItemEditWindow(SharedTagDefinitionItemVM item, object parameter, out string saveProgressTitle)
        {
            ...
            return service.RunAsync("Loading Details", "Connecting to database", item.Model.Id, LoadItemAsync).ContinueWith(task => Dispatcher.Invoke(() =>
            {
                ...
                if (entity is null)
                    return false;
                EditSharedTagDefinitionVM viewModel = new();
                return viewModel.ShowDialog(new View.Local.EditSharedTagDefinitionWindow(), entity, false) ?? false;
            }), TaskContinuationOptions.OnlyOnRanToCompletion).Result;
        }

        private async Task<SharedTagDefinition> LoadItemAsync(Guid id, IWindowsStatusListener arg)
        {
            using IServiceScope serviceScope = Services.ServiceProvider.CreateScope();
            using LocalDbContext dbContext = serviceScope.ServiceProvider.GetRequiredService<LocalDbContext>();
            return await dbContext.SharedTagDefinitions.FindAsync(id);
        }
        ...
        protected override bool PromptItemDeleting(SharedTagDefinitionItemVM item, object parameter, out string deleteProgressTitle)
        {
            ...
            return MessageBox.Show(serviceScope.ServiceProvider.GetRequiredService<MainWindow>(),
                "This cannot be undone.\n\nAre you sure you want to delete this Shared Tag Definition?", "Delete Tag Definition", MessageBoxButton.YesNo,
