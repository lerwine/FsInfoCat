...
namespace FsInfoCat.Desktop.ViewModel.Filter.Historical
{
    ...
    public abstract class RelativeHistoricalTime : HistoricalTimeReference, IRelativeTimeReference
    {
        ...
        /// </summary>
        public static readonly DependencyProperty DaysProperty = DependencyPropertyBuilder<RelativeHistoricalTime, int>
            .Register(nameof(Days))
            .DefaultValue(0)
            .OnChanged((d, oldValue, newValue) => (d as RelativeHistoricalTime)?.OnDaysPropertyChanged(oldValue, newValue))
            .AsReadWrite();
        ...
        /// </summary>
        public static readonly DependencyProperty HoursProperty = DependencyPropertyBuilder<RelativeHistoricalTime, int>
            .Register(nameof(Hours))
            .DefaultValue(0)
            .OnChanged((d, oldValue, newValue) => (d as RelativeHistoricalTime)?.OnHoursPropertyChanged(oldValue, newValue))
            .AsReadWrite();
