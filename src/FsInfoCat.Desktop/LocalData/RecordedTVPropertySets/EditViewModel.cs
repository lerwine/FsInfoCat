...
namespace FsInfoCat.Desktop.LocalData.RecordedTVPropertySets
{
        ...
        INavigatedToNotifiable, INavigatingFromNotifiable
    {
        ...
        protected virtual void OnSaveChangesCommand(object parameter)
        {
            ...
            {
                // TODO: Implement RecordedTVPropertySets.EditViewModel.OnSaveChangesCommand
        ...
        private static readonly DependencyPropertyKey ListItemPropertyKey = DependencyPropertyBuilder<EditViewModel, RecordedTVPropertiesListItem>
        ...
        public RecordedTVPropertiesListItem ListItem { get => (RecordedTVPropertiesListItem)GetValue(ListItemProperty); private set => SetValue(ListItemPropertyKey, value); }
        ...
        public EditViewModel([DisallowNull] RecordedTVPropertySet entity, RecordedTVPropertiesListItem listItem) : base(entity)
        {
            ...
            if (ApplyChanges())
            {
                    ...
                    MessageBoxButton.YesNoCancel, MessageBoxImage.Warning))
                {
                    case MessageBoxResult.Yes:
                        // TODO: Implement RecordedTVPropertySets.EditViewModel.OnNavigatingFrom
                        throw new NotImplementedException();
                        //IWindowsAsyncJobFactoryService jobFactory = Hosting.GetRequiredService<IWindowsAsyncJobFactoryService>();
                        //IAsyncJob<RecordedTVPropertiesListItem> job = jobFactory.StartNew("Saving changes", "Opening database", Entity, InvocationState, SaveChangesAsync);
                        //job.Task.ContinueWith(task => Dispatcher.Invoke(() => OnSaveTaskCompleted(task)));
