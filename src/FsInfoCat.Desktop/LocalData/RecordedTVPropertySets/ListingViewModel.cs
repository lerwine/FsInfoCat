...
{
    public class ListingViewModel : ListingViewModel<RecordedTVPropertiesListItem, ListItemViewModel, bool?, RecordedTVPropertySet, ItemEditResult>, INavigatedToNotifiable
    {
        ...
        protected override async Task<PageFunction<ItemEditResult>> GetEditPageAsync(RecordedTVPropertySet args, [DisallowNull] IWindowsStatusListener statusListener)
        {
            EditViewModel viewModel;
            if (args is null)
                viewModel = new(new RecordedTVPropertySet(), true);
            else
                viewModel = new EditViewModel(args, false);
            return new EditPage(viewModel);
        }

        protected override async Task<RecordedTVPropertySet> LoadItemAsync([DisallowNull] RecordedTVPropertiesListItem item, [DisallowNull] IWindowsStatusListener statusListener)
        {
