...
{
    public class EditViewModel : CrawlJobLogEditViewModel<CrawlJobLog, CrawlConfigListItem, CrawlConfigurations.ListItemViewModel>, INavigatedToNotifiable, INavigatingFromNotifiable
    {
        ...
        protected virtual void OnSaveChangesCommand(object parameter)
        {
            ...
            {
                // TODO: Implement CrawlLogs.EditViewModel.OnSaveChangesCommand
        ...
        private static readonly DependencyPropertyKey ListItemPropertyKey = DependencyPropertyBuilder<EditViewModel, CrawlJobLogListItem>
        ...
        public CrawlJobLogListItem ListItem { get => (CrawlJobLogListItem)GetValue(ListItemProperty); private set => SetValue(ListItemPropertyKey, value); }
        ...
        public EditViewModel(CrawlJobLog entity, CrawlJobLogListItem listItem) : base(entity, listItem)
        {
