...
{
    public class ListingViewModel : ListingViewModel<MediaPropertiesListItem, ListItemViewModel, bool?, ItemEditResult>, INavigatedToNotifiable
    {
        ...
        protected async override Task<PageFunction<ItemEditResult>> GetDetailPageAsync([DisallowNull] ListItemViewModel item, [DisallowNull] IWindowsStatusListener statusListener)
        {
            ...
            if (item is null)
                viewModel = new(new MediaPropertySet(), null);
            else
            {
