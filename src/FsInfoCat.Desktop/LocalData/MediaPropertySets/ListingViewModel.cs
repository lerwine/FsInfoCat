...
{
    public class ListingViewModel : ListingViewModel<MediaPropertiesListItem, ListItemViewModel, bool?, MediaPropertySet, ItemEditResult>, INavigatedToNotifiable
    {
        ...
        protected override bool EntityMatchesCurrentFilter([DisallowNull] MediaPropertiesListItem entity)
        {
        ...
        protected override PageFunction<ItemEditResult> GetEditPage(MediaPropertySet args)
        {
            ...
            if (args is null)
                viewModel = new(new MediaPropertySet(), true);
            else
                viewModel = new EditViewModel(args, false);
            return new EditPage(viewModel);
        }

        protected override async Task<MediaPropertySet> LoadItemAsync([DisallowNull] MediaPropertiesListItem item, [DisallowNull] IWindowsStatusListener statusListener)
        {
