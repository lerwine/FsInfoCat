...
namespace FsInfoCat.Desktop.LocalData.GPSPropertySets
{
        ...
        INavigatedToNotifiable, INavigatingFromNotifiable
    {
        ...
        private static readonly DependencyPropertyKey ListItemPropertyKey = DependencyPropertyBuilder<EditViewModel, GPSPropertiesListItem>
        ...
        public GPSPropertiesListItem ListItem { get => (GPSPropertiesListItem)GetValue(ListItemProperty); private set => SetValue(ListItemPropertyKey, value); }
        ...
        public EditViewModel([DisallowNull] GPSPropertySet entity, GPSPropertiesListItem listItem) : base(entity)
        {
        ...
        private bool ApplyChanges()
        {
            ...
            Entity.LatitudeMinutes = LatitudeMinutes;
            Entity.LatitudeRef = LatitudeRef;
            Entity.LatitudeSeconds = LatitudeSeconds;
            Entity.LongitudeDegrees = LongitudeDegrees;
            Entity.LongitudeMinutes = LongitudeMinutes;
            Entity.LongitudeRef = LongitudeRef;
            Entity.LongitudeSeconds = LongitudeSeconds;
            Entity.MeasureMode = MeasureMode;
        ...
        private static async Task<GPSPropertiesListItem> SaveChangesAsync(GPSPropertySet entity, object invocationState, IActivityProgress progress)
        {
            ...
            if (isNew)
                return await dbContext.GPSPropertiesListing.FindAsync(entity.Id, progress.Token);
