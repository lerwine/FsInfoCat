...
{
    public class FileSystemItemViewModel : FileSystemListItemViewModel<FileSystemListItem>, ILocalCrudEntityRowViewModel<FileSystemListItem>
    {
        ...
        private static readonly DependencyPropertyKey UpstreamIdPropertyKey = DependencyProperty.RegisterReadOnly(nameof(UpstreamId), typeof(Guid?),
            typeof(FileSystemItemViewModel), new PropertyMetadata(null));
