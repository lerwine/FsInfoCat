...
{
    public class ListingViewModel : ListingViewModel<ImagePropertiesListItem, ListItemViewModel, bool?, ImagePropertySet, ItemEditResult>, INavigatedToNotifiable
    {
        ...
        protected override bool EntityMatchesCurrentFilter(ImagePropertiesListItem entity)
        {
            throw new NotImplementedException();
        }

        protected override PageFunction<ItemEditResult> GetEditPage(ImagePropertySet args)
        {
            throw new NotImplementedException();
        }

        protected override Task<ImagePropertySet> LoadItemAsync([DisallowNull] ImagePropertiesListItem item, [DisallowNull] IWindowsStatusListener statusListener)
        {
            throw new NotImplementedException();
        }
