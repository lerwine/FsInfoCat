    ...
    public class AppUserUnitTest
    {
        static object[] GetNormalizeTestCases()
        {
            return new object[]
            {
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("90b932df-3ab5-4299-a3f3-dd1655cbf93e"), DisplayName = " Leonard\nErwine ", LoginName = " erwinel ",
                        Role = UserRole.Admin, Notes = " ",
                    ...
                    new AppUser(new Account { AccountID = new Guid("90b932df-3ab5-4299-a3f3-dd1655cbf93e"), DisplayName = "Leonard Erwine", LoginName = "erwinel",
                        Role = UserRole.Admin, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("7050184e-a998-4088-b547-d70cd806b2c7"), DisplayName = "  \n  ", LoginName = "blackwellt",
                        Role = UserRole.Admin, Notes = "\r\n\n\r\r\n\n\r",
                    ...
                    new AppUser(new Account { AccountID = new Guid("7050184e-a998-4088-b547-d70cd806b2c7"), DisplayName = "blackwellt", LoginName = "blackwellt",
                        Role = UserRole.Admin, Notes = "",
                        CreatedOn = new DateTime(2014, 9, 22, 14, 21, 47, 861, DateTimeKind.Local), CreatedBy = Guid.Empty,
                        ModifiedOn = new DateTime(2014, 9, 22, 14, 21, 47, 861, DateTimeKind.Local), ModifiedBy = Guid.Empty }),
                },
        ...
        static object[] GetValidateAllTestCases()
        {
            return new object[]
            {
                new object[]
                {
                    new AppUser(new Account { AccountID = Guid.Empty, DisplayName = "FS InfoCat Administrator", LoginName = "admin", Role = UserRole.Admin, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("90b932df-3ab5-4299-a3f3-dd1655cbf93e"), DisplayName = "\n", LoginName = "erwinel", Role = UserRole.Admin, Notes = "",
                        CreatedOn = new DateTime(2014, 6, 5, 14, 50, 37, 729, DateTimeKind.Local), CreatedBy = Guid.Empty,
                        ModifiedOn = new DateTime(2014, 6, 5, 14, 50, 37, 729, DateTimeKind.Local), ModifiedBy = Guid.Empty }),
                    new ValidationResult[0]
                },
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("7050184e-a998-4088-b547-d70cd806b2c7"), DisplayName = "Tanya Blackwell", LoginName = "", Role = UserRole.Admin, Notes = "",
                        CreatedOn = new DateTime(2014, 9, 22, 14, 21, 47, 861, DateTimeKind.Local), CreatedBy = Guid.Empty,
                        ModifiedOn = new DateTime(2014, 9, 22, 14, 21, 47, 861, DateTimeKind.Local), ModifiedBy = Guid.Empty }),
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("96077af4-e35d-45b5-9094-02213cd0ba80"), DisplayName = "Nur Murillo", LoginName = "  ", Role = UserRole.Crawler, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("0cf932e4-be15-4797-84ec-3eb9d86a9376"), DisplayName = "Hubert Davies", LoginName = ".daviesh", Role = UserRole.Crawler, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("79010060-4bb5-47b8-ad33-7f92623a5f3e"), DisplayName = "Doctor of Democrat Socializm Maeinendtacious Mcleodeofolindinski the great of the lasting foreverking and don't you forget it bub", LoginName = "mcleod.m", Role = UserRole.None, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("71fffce1-ed11-4efe-92fe-7096c27a4665"), DisplayName = "Doctor     of    Democrat               Statist                 Moses   Connerifficexpialicious                  the   fourteenth", LoginName = "\r\n", Role = UserRole.User, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("ef412251-042e-4ef3-8afb-5afef51dc66f"), DisplayName = "Ayaan Mercado", LoginName = ".mercadoamccabernichollsdhebertax", Role = UserRole.User, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("c60904fe-8bae-4300-80dd-679dd174db42"), DisplayName = "Lucian Firth", LoginName = ".firthllittledortizmpenningtonla", Role = UserRole.User, Notes = "",
                ...
                new object[]
                {
                    new AppUser(new Account { AccountID = new Guid("7e2cd7b2-32de-420e-8ac2-6ab9a1c735c7"), DisplayName = "Woodrow Lindsay", LoginName = "lindsayw", Role = UserRole.User, Notes = "",
        ...
        public void ValidateAllTest(AppUser target, IList<ValidationResult> expected)
        {
