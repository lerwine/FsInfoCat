...
namespace FsInfoCat
{
    ...
    /// <remarks>
    ///   <list type="bullet">
    ///     <item>The <see cref="StatusMessageLevelAttribute" /> determines the related <see cref="Model.StatusMessageLevel" /> for the enumerated member.
    ///         Use <see cref="StatusMessageLevelAttribute.TryGetLevel{TEnum}(TEnum, out Model.StatusMessageLevel)"/> to determine the appropriate value.</item>
    ///     <item>The <see cref="ErrorCodeAttribute"/> indicates the related <see cref="Model.ErrorCode"/> if present; otherwise, the enuemrated member has no
    ///         related <see cref="ErrorCode"/>. Use <see cref="ErrorCodeAttribute.TryGetCode{TEnum}(TEnum, out Model.ErrorCode)"/> to determine
    ...
    public enum MessageCode : int
    {
        ...
        /// sense.</remarks>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.Unexpected)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.IOError)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.UnauthorizedAccess)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.SecurityException)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.InvalidPath)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.PathTooLong)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.CrawlOperationFailed)]
        ...
        /// </summary>
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.DirectoryNotFound)]
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.GetLogicalDisksFailure)]
        ...
        [StatusMessageLevel(Model.StatusMessageLevel.Warning)]
        ...
        [StatusMessageLevel(Model.StatusMessageLevel.Error)]
        [ErrorCode(Model.ErrorCode.BackgroundJobFaulted)]
