...
namespace FsInfoCat
{
    ...
    /// </summary>
    /// <remarks>The <see cref="MessageCodeAttribute" /> determines the related <see cref="Model.MessageCode" /> for the enumerated member.
    /// Use <see cref="MessageCodeAttribute.TryGetCode{TEnum}(TEnum, out Model.MessageCode)"/> to determine the appropriate value.
    /// </remarks>
    ...
    public enum ErrorCode : int
    {
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.UnexpectedError)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.IOError)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.UnauthorizedAccess)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.SecurityException)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.InvalidPath)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.PathTooLong)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.CrawlOperationFailed)]
        ...
        /// </summary>
        [MessageCode(Model.MessageCode.DirectoryNotFound)]
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        [MessageCode(Model.MessageCode.GetLogicalDisksFailure)]
        ...
        [MessageCode(Model.MessageCode.BackgroundJobFaulted)]
