...
namespace FsInfoCat.Upstream.Model
{
    ...
    public interface IUpstreamVolume : IUpstreamVolumeRow, IVolume, IEquatable<IUpstreamVolume>
    {
        ...
        [Display(Name = nameof(Properties.Resources.HostDevice), ResourceType = typeof(Properties.Resources))]
        ...
        [Display(Name = nameof(Properties.Resources.RootDirectory), ResourceType = typeof(Properties.Resources))]
