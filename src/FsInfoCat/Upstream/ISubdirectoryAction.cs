...
namespace FsInfoCat.Upstream
{
    ...
    public interface ISubdirectoryAction : IUpstreamDbEntity
    {
        ...
        [Display(Name = nameof(Properties.Resources.DisplayName_SubdirectoryAction_Task), ShortName = nameof(Properties.Resources.DisplayName_Task), Description = nameof(Properties.Resources.Description_SubdirectoryAction_Task),
            ResourceType = typeof(Properties.Resources))]
        IMitigationTask Task { get; }

        /// <summary>Gets the source sub-directory.</summary>
        /// <value>The source subdirectory to be deleted, moved or copied.</value>
        [Display(Name = nameof(Properties.Resources.DisplayName_SubdirectoryAction_Source), ShortName = nameof(Properties.Resources.DisplayName_Source), Description = nameof(Properties.Resources.Description_SubdirectoryAction_Source),
            ResourceType = typeof(Properties.Resources))]
        ...
        /// <remarks>
        /// The <see cref="DirectoryCrawlOptions.FlaggedForDeletion" /> <see cref="ISubdirectory.Options">file options flag</see> combined with the value of this field determines whether a file should be deleted,
        /// moved or copied, as follows:
        /// <list type="table">
        /// <item>
