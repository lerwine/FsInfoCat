...
namespace FsInfoCat.Model
{
    ...
    /// </summary>
    /// <remarks>The <see cref="FsInfoCat.MessageCodeAttribute" /> determines the related <see cref="FsInfoCat.MessageCode" /> for the enumerated member.
    /// Use <see cref="FsInfoCat.MessageCodeAttribute.TryGetCode{TEnum}(TEnum, out FsInfoCat.MessageCode)"/> to determine the appropriate value.
    /// </remarks>
    public enum ErrorCode : int
    {
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.UnexpectedError)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.IOError)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.UnauthorizedAccess)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.SecurityException)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.InvalidPath)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.PathTooLong)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.CrawlOperationFailed)]
        ...
        /// </summary>
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.DirectoryNotFound)]
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.GetLogicalDisksFailure)]
        ...
        [FsInfoCat.MessageCode(FsInfoCat.MessageCode.BackgroundJobFaulted)]
