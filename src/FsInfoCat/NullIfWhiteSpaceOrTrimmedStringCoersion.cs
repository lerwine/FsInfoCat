...
/// <summary>
/// Coerces to a null or non-empty, whitespace-normalized, trimmed string value.
/// </summary>
...
{
    /// <summary>
    /// Gets the default <see cref="NullIfWhiteSpaceOrTrimmedStringCoersion"/> instance.
    /// </summary>
    ...
    public virtual string Coerce(object obj) => (obj is null) ? null : StringExtensionMethods.TrimmedOrNullIfWhiteSpace((obj is string text) ? text : obj.ToString());
