...
namespace FsInfoCat.Local
{
    ...
    public interface ILocalFile : ILocalDbFsItem, IFile, ILocalFileRow, IEquatable<ILocalFile>
    {
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaBinaryPropertySet" /> that contains the summary properties for the current file or <see langword="null" /> if no summary properties
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaDocumentPropertySet" /> that contains the document properties for the current file or <see langword="null" /> if no document
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaAudioPropertySet" /> that contains the audio properties for the current file or <see langword="null" /> if no audio properties are
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaDRMPropertySet" /> that contains the DRM properties for the current file or <see langword="null" /> if no DRM properties are defined
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaGPSPropertySet" /> that contains the GPS properties for the current file or <see langword="null" /> if no GPS properties are defined
        /// on the current file.</value>
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaImagePropertySet" /> that contains the image properties for the current file or <see langword="null" /> if no image properties are
        /// defined on the current file.</value>
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaMediaPropertySet" /> that contains the media properties for the current file or <see langword="null" /> if no media properties are
        /// defined on the current file.</value>
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaMusicPropertySet" /> that contains the music properties for the current file or <see langword="null" /> if no music properties are
        /// defined on the current file.</value>
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaPhotoPropertySet" /> that contains the photo properties for the current file or <see langword="null" /> if no photo properties are
        /// defined on the current file.</value>
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaRecordedTVPropertySet" /> that contains the recorded TV properties for the current file or <see langword="null" /> if no recorded
        ...
        /// </summary>
        /// <value>The generic <see cref="ILocaVideoPropertySet" /> that contains the video properties for the current file or <see langword="null" /> if no video properties are
        /// defined on the current file.</value>
        ...
        /// </summary>
        /// <value>
        /// An <see cref="ILocaRedundancy" /> object that indicates the current file is an exact copy of other files that belong to the
