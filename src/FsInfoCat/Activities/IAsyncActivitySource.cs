...
namespace FsInfoCat.Activities
{
    ...
    /// <remarks>This contains a collection of <see cref="IAsyncActivity"/> objects representing asynchronous activities that have not yet completed.
    /// Once an activity has completed, it will be automatically removed from this collection.</remarks>
