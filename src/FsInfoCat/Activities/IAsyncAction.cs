...
namespace FsInfoCat.Activities
{
    ...
    public interface IAsyncAction<TEvent> : IObservable<TEvent>, IAsyncActivity where TEvent : IActivityEvent { }
    ...
    public interface IAsyncAction<TEvent, TState> : IOperationInfo<TState>, IAsyncAction<TEvent> where TEvent : IActivityEvent<TState> { }
}
