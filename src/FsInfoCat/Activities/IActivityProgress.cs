...
namespace FsInfoCat.Activities
{
    ...
    public interface IActivityProgress : IProgress<string>, IProgress<Exception>, IProgress<int>, IOperationInfo, IAsyncActivityProvider
    {
        ...
        /// <summary>
        /// Updates the <see cref="IActivityInfo.StatusMessage"/>, <see cref="IOperationInfo.CurrentOperation"/> and <see cref="IOperationInfo.PercentComplete"/> properties
        /// for this progress object and reports a non-fatal operation error.
        /// </summary>
        ...
        /// the <see cref="IActivityEvent.Exception"/>, even if the value of <see cref="IActivityInfo.StatusMessage"/>, <see cref="IOperationInfo.CurrentOperation"/>
        /// or <see cref="IOperationInfo.PercentComplete"/> does not change.
        ...
        /// <summary>
        /// Updates the <see cref="IActivityInfo.StatusMessage"/>, <see cref="IOperationInfo.CurrentOperation"/> and <see cref="IOperationInfo.PercentComplete"/> properties for
        /// this progress object and reports the changed operation status.
        /// </summary>
        /// <param name="statusDescription">The new value of <see cref="IActivityInfo.StatusMessage"/>.</param>
        /// <param name="currentOperation">The new value for <see cref="IOperationInfo.CurrentOperation"/>.</param>
        /// <param name="percentComplete">The new value for <paramref name="IOperationInfo.PercentComplete"/> as value from <c>-1</c> through <c>100</c>, where <c>-1</c> indicates
        ...
        /// <exception cref="ArgumentException"><paramref name="statusDescription"/> is <see langword="null"/>, <see cref="string.Empty"/>
        /// or contains only <see cref="string.IsNullOrWhiteSpace(string)">white space characters</see>.</exception>
        /// <remarks>If the value of <see cref="IActivityInfo.StatusMessage"/>, <see cref="IOperationInfo.CurrentOperation"/> or <see cref="IOperationInfo.PercentComplete"/>
        /// changes, then an activity notification event will be pushed to reflect the new operational state; otherwise, this will have no effect.
        /// <para>Any white space in <paramref name="statusDescription"/> will normalized before it is applied to <see cref="IActivityInfo.StatusMessage"/>.</para>
        /// <para>If <paramref name="currentOperation"/> is <see langword="null"/> it will converted to a <see cref="string.Empty"/>; otherwise, any extraneous whitespace will be
        /// trimmed.</para></remarks>
        ...
        /// or contains only <see cref="string.IsNullOrWhiteSpace(string)">white space characters</see>.</exception>
        /// <remarks>Calling this method will result in an activity notification event being pushed with the specified <paramref name="error"/> as
        /// the <see cref="IActivityEvent.Exception"/>, even if the value of <see cref="IActivityInfo.StatusMessage"/> or <see cref="IOperationInfo.CurrentOperation"/> does not
        /// change.
        /// <para>The <see cref="IOperationInfo.CurrentOperation"/> property will be set to a <see cref="string.Empty"/> on this progress object and on the
        /// pushed <see cref="IOperationEvent"/>.</para>
        /// <para>Any white space in <paramref name="statusDescription"/> will normalized before it is applied to <see cref="IActivityInfo.StatusMessage"/>.</para>
        /// <para>If <paramref name="currentOperation"/> is <see langword="null"/> it will converted to a <see cref="string.Empty"/>; otherwise, any extraneous whitespace will be
        /// trimmed.</para></remarks>
        ...
        /// or contains only <see cref="string.IsNullOrWhiteSpace(string)">white space characters</see>.</exception>
        /// <remarks>Calling this method will result in an activity notification event being pushed with the specified <paramref name="error"/> as
        /// the <see cref="IActivityEvent.Exception"/>, even if the value of <see cref="IActivityInfo.StatusMessage"/> or <see cref="IOperationInfo.PercentComplete"/> does not
        /// change.
        /// <para>The <see cref="IOperationInfo.CurrentOperation"/> property will be set to a <see cref="string.Empty"/> on this progress object and on the
        /// pushed <see cref="IOperationEvent"/>.</para>
        ...
        /// <exception cref="ArgumentException"><paramref name="statusDescription"/> is <see langword="null"/>, <see cref="string.Empty"/>
        /// or contains only <see cref="string.IsNullOrWhiteSpace(string)">white space characters</see>.</exception>
        /// <remarks>If the value of <see cref="IActivityInfo.StatusMessage"/> or <see cref="IOperationInfo.CurrentOperation"/> changes, then an activity notification event will
        ...
        /// or contains only <see cref="string.IsNullOrWhiteSpace(string)">white space characters</see>.</exception>
        /// <remarks>Calling this method will result in an activity notification event being pushed with the specified <paramref name="error"/> as
        /// the <see cref="IActivityEvent.Exception"/>, even if the value of <see cref="IOperationInfo.CurrentOperation"/> does not change.
        /// <para>The pushed <see cref="IOperationEvent"/> will be populated with the latest <see cref="IOperationInfo.PercentComplete"/>,
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="percentComplete"/> is less than <c>-1</c> or greater than <c>100</c>.</exception>
        /// <remarks>Calling this method will result in an activity notification event being pushed with the specified <paramref name="error"/> as
        /// the <see cref="IActivityEvent.Exception"/>, even if the value of <see cref="IOperationInfo.CurrentOperation"/> or <see cref="IOperationInfo.PercentComplete"/> does not
        /// change.
