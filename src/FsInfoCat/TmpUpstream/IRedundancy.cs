...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="Local.Model.IRedundancy" />
    public interface IUpstreamRedundancy : IUpstreamDbEntity, M.IRedundancy, IHasMembershipKeyReference<IUpstreamRedundantSet, IUpstreamFile>, IEquatable<IUpstreamRedundancy>
    {
        /// <summary>
