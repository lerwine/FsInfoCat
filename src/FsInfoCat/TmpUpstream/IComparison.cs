...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="M.IComparison" />
    /// <seealso cref="IEquatable{IUpstreamComparison}" />
    /// <seealso cref="Local.Model.IComparison" />
    public interface IUpstreamComparison : IUpstreamDbEntity, M.IComparison, IHasMembershipKeyReference<IUpstreamFile, IUpstreamFile>, IEquatable<IUpstreamComparison>
    {
        /// <summary>
