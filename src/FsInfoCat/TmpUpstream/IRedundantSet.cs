...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="M.IRedundantSet" />
    /// <seealso cref="IEquatable{IUpstreamRedundantSet}" />
    /// <seealso cref="Local.Model.IRedundantSet" />
    public interface IUpstreamRedundantSet : IUpstreamRedundantSetRow, M.IRedundantSet, IEquatable<IUpstreamRedundantSet>
    {
        /// <summary>
