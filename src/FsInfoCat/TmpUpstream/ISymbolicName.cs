...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="Local.Model.ISymbolicName" />
    public interface IUpstreamSymbolicName : IUpstreamSymbolicNameRow, M.ISymbolicName, IEquatable<IUpstreamSymbolicName>
    {
        /// <summary>
