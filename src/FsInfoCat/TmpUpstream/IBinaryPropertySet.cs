...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="Local.Model.IBinaryPropertySet" />
    public interface IUpstreamBinaryPropertySet : IUpstreamDbEntity, M.IBinaryPropertySet, IEquatable<IUpstreamBinaryPropertySet>
    {
        /// <summary>
