...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="M.ITagDefinition" />
    /// <seealso cref="IEquatable{IUpstreamTagDefinition}" />
    /// <seealso cref="Local.Model.ITagDefinition" />
    public interface IUpstreamTagDefinition : IUpstreamTagDefinitionRow, M.ITagDefinition, IEquatable<IUpstreamTagDefinition>
    {
        /// <summary>
        /// Gets the file tags.
        /// </summary>
