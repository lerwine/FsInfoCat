...
namespace FsInfoCat.Upstream.Model
{
    ...
    /// <seealso cref="Local.Model.ICrawlConfiguration" />
    public interface IUpstreamCrawlConfiguration : IUpstreamDbEntity, M.ICrawlConfiguration, IEquatable<IUpstreamCrawlConfiguration>
    {
        /// <summary>
