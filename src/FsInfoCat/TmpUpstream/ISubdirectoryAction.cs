...
namespace FsInfoCat.Upstream.Model
{
    ...
    public interface ISubdirectoryAction : ISubdirectoryActionRow, IEquatable<ISubdirectoryAction>
    {
        ...
        /// <remarks>
        /// The <see cref="DirectoryCrawlOptions.FlaggedForDeletion" /> <see cref="M.ISubdirectoryRow.Options">file options flag</see> combined with the value of this field determines
        ...
        ///     <description><see cref="DirectoryCrawlOptions.FlaggedForDeletion" /> <see cref="M.ISubdirectoryRow.Options">options flag</see> is set:</description>
        ...
        /// <item>
        ///     <description>Not <see langword="null"/></description>
        ///     <description><see cref="DirectoryCrawlOptions.FlaggedForDeletion" /> <see cref="M.ISubdirectoryRow.Options">options flag</see> is not set.</description>
