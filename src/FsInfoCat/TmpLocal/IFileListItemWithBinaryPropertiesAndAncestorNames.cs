...
namespace FsInfoCat.Local.Model
{
    ...
    public interface ILocalFileListItemWithBinaryPropertiesAndAncestorNames : M.IFileListItemWithBinaryPropertiesAndAncestorNames, ILocalFileListItemWithAncestorNames { }
}
