...
namespace FsInfoCat.Local.Model
{
    ...
    /// <seealso cref="Upstream.Model.IRedundancy" />
    public interface ILocalRedundancy : ILocalDbEntity, M.IRedundancy, IHasMembershipKeyReference<ILocalRedundantSet, ILocalFile>, IEquatable<ILocalRedundancy>
    {
        /// <summary>
