...
namespace FsInfoCat.Local.Model
{
    ...
    /// <seealso cref="M.ISubdirectory" />
    /// <seealso cref="IEquatable{ILocalSubdirectory}" />
    /// <seealso cref="Upstream.Model.ISubdirectory" />
    public interface ILocalSubdirectory : ILocalDbFsItem, M.ISubdirectory, ILocalSubdirectoryRow, IEquatable<ILocalSubdirectory>
    {
        /// <summary>
