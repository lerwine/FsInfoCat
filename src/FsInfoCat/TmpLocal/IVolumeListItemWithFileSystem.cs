...
namespace FsInfoCat.Local.Model
{
    ...
    /// <seealso cref="Upstream.Model.IVolumeListItemWithFileSystem" />
    public interface ILocalVolumeListItemWithFileSystem : ILocalVolumeListItem, M.IVolumeListItemWithFileSystem { }
}
