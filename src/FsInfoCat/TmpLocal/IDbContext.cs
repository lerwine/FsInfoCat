...
namespace FsInfoCat.Local.Model
{
    ...
    /// Extends the <see cref="M.IDbContext" /> interface to represent the local database.
    /// </summary>
    /// <seealso cref="M.IDbContext" />
    /// <seealso cref="Upstream.Model.IDbContext" />
    public interface ILocalDbContext : M.IDbContext
    {
        /// <summary>
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        new Task<ILocalSummaryPropertySet> FindMatchingAsync(M.ISummaryProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalDocumentPropertySet> FindMatchingAsync(M.IDocumentProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalAudioPropertySet> FindMatchingAsync(M.IAudioProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalDRMPropertySet> FindMatchingAsync(M.IDRMProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalGPSPropertySet> FindMatchingAsync(M.IGPSProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalImagePropertySet> FindMatchingAsync(M.IImageProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalMediaPropertySet> FindMatchingAsync(M.IMediaProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalMusicPropertySet> FindMatchingAsync(M.IMusicProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalPhotoPropertySet> FindMatchingAsync(M.IPhotoProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalRecordedTVPropertySet> FindMatchingAsync(M.IRecordedTVProperties properties, CancellationToken cancellationToken);
        ...
        new Task<ILocalVideoPropertySet> FindMatchingAsync(M.IVideoProperties properties, CancellationToken cancellationToken);
    }
}
