...
namespace FsInfoCat.Local.Model
{
    ...
    /// <seealso cref="Upstream.Model.IFileAccessError" />
    public interface ILocalFileAccessError : ILocalAccessError, M.IFileAccessError, IEquatable<ILocalFileAccessError>
    {
        /// <summary>
