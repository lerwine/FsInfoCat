...
namespace FsInfoCat.Local.Model
{
    ...
    /// <seealso cref="M.ICrawlJobLog" />
    /// <seealso cref="IEquatable{ILocalCrawlJobLog}" />
    /// <seealso cref="Upstream.Model.ICrawlJobLog" />
    public interface ILocalCrawlJobLog : ILocalCrawlJobLogRow, M.ICrawlJobLog, IEquatable<ILocalCrawlJobLog>
    {
        /// <summary>
