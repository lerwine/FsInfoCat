...
public static class XmlExtensionMethods
{
    ...
    public static IEnumerable<XAttribute> Attributes(this XElement element, XmlNames name) => element?.Attributes(GetLocalXName(name)) ?? [];

    public static IEnumerable<XAttribute> Attributes(this IEnumerable<XElement> source, XmlNames name) => source?.Attributes(GetLocalXName(name)) ?? [];

    #endregion

    #region Descendants

    public static IEnumerable<XElement> Descendants(this XContainer container, XmlNames name) => container?.Descendants(GetModelXName(name)) ?? [];

    public static IEnumerable<XElement> Descendants<T>(this IEnumerable<T> source, XmlNames name) where T : XContainer => source?.Descendants(GetModelXName(name)) ?? [];

    public static IEnumerable<XElement> DescendantsAndSelf(this IEnumerable<XElement> source, XmlNames name) => source?.DescendantsAndSelf(GetModelXName(name)) ?? [];
    ...
    public static IEnumerable<XElement> Elements(this XContainer container, XmlNames name) => container?.Elements(GetModelXName(name)) ?? [];

    public static IEnumerable<XElement> Elements(this IEnumerable<XElement> source, XmlNames name) => source?.Elements(GetModelXName(name)) ?? [];
    ...
    {
        if (name is null) throw new ArgumentNullException(nameof(name));
        return container?.Elements().Where(e => !name.Equals(e.Name)) ?? [];
    }
    ...
    {
        if (name is null) throw new ArgumentNullException(nameof(name));
        return source?.Elements().Where(e => !name.Equals(e.Name)) ?? [];
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XName attributeName, string value, IEqualityComparer<string> comparer = null)
    {
        ...
        return container is null ? [] : Backing_ElementsWithAttribute(container, attributeName, value, comparer);
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XmlNames attributeName, string value, IEqualityComparer<string> comparer = null) =>
        (container is null) ? [] : Backing_ElementsWithAttribute(container, GetLocalXName(attributeName), value, comparer);
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, attributeName, value, comparer);
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XmlNames attributeName, string value, IEqualityComparer<string> comparer = null) =>
        (source is null) ? [] : Backing_ElementsWithAttribute(source, GetLocalXName(attributeName), value, comparer);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XName elementName, XName attributeName, string value, IEqualityComparer<string> comparer = null)
    {
        ...
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, elementName, attributeName, value, comparer);
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XName elementName, XName attributeName, string value, IEqualityComparer<string> comparer = null)
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, elementName, attributeName, value, comparer);
    }
    ...
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, elementName, attributeName.GetLocalXName(), value, comparer);
    }
    ...
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, elementName, attributeName.GetLocalXName(), value, comparer);
    }
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, elementName.GetLocalXName(), attributeName, value, comparer);
    }
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, elementName.GetLocalXName(), attributeName, value, comparer);
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XmlNames elementName, XmlNames attributeName, string value, IEqualityComparer<string> comparer = null) =>
        (container is null) ? [] : Backing_ElementsWithAttribute(container, GetLocalXName(elementName), GetLocalXName(attributeName), value, comparer);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XmlNames elementName, XmlNames attributeName, string value, IEqualityComparer<string> comparer = null) =>
        (source is null) ? [] : Backing_ElementsWithAttribute(source, GetLocalXName(elementName), GetLocalXName(attributeName), value, comparer);
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return container is null ? [] : container.Backing_ElementsWithAttribute(attributeName, value);
    }

    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XmlNames attributeName, bool value) =>
        (container is null) ? [] : Backing_ElementsWithAttribute(container, GetLocalXName(attributeName), value);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XmlNames attributeName, bool value) =>
        (source is null) ? [] : Backing_ElementsWithAttribute(source, GetLocalXName(attributeName), value);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XmlNames elementName, XmlNames attributeName, bool value) =>
        (container is null) ? [] : Backing_ElementsWithAttribute(container, GetLocalXName(elementName), GetLocalXName(attributeName), value);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XmlNames elementName, XmlNames attributeName, bool value) =>
        (source is null) ? [] : Backing_ElementsWithAttribute(source, GetLocalXName(elementName), GetLocalXName(attributeName), value);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XmlNames attributeName, DateTime value,
            XmlDateTimeSerializationMode mode = XmlDateTimeSerializationMode.RoundtripKind) =>
        (container is null) ? [] : Backing_ElementsWithAttribute(container, GetLocalXName(attributeName), value, mode);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XmlNames attributeName, DateTime value,
            XmlDateTimeSerializationMode mode = XmlDateTimeSerializationMode.RoundtripKind) =>
        (source is null) ? [] : Backing_ElementsWithAttribute(source, GetLocalXName(attributeName), value, mode);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XmlNames elementName, XmlNames attributeName, DateTime value,
            XmlDateTimeSerializationMode mode = XmlDateTimeSerializationMode.RoundtripKind) =>
        (container is null) ? [] : Backing_ElementsWithAttribute(container, GetLocalXName(elementName), GetLocalXName(attributeName), value, mode);
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XmlNames elementName, XmlNames attributeName, DateTime value,
            XmlDateTimeSerializationMode mode = XmlDateTimeSerializationMode.RoundtripKind) =>
        (source is null) ? [] : Backing_ElementsWithAttribute(source, GetLocalXName(elementName), GetLocalXName(attributeName), value, mode);
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, attributeName, value);
    }
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, attributeName, value);
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this XContainer container, XName elementName, XName attributeName, TimeSpan value)
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, elementName, attributeName, value);
    }
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, elementName.GetLocalXName(), attributeName, value);
    }
    ...
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        return container is null ? [] : Backing_ElementsWithAttribute(container, elementName, attributeName.GetLocalXName(), value);
    }
    ...
    public static IEnumerable<XElement> ElementsWithAttribute(this IEnumerable<XElement> source, XName elementName, XName attributeName, TimeSpan value)
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, elementName, attributeName, value);
    }
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, elementName.GetLocalXName(), attributeName, value);
    }
    ...
    {
        if (elementName is null) throw new ArgumentNullException(nameof(elementName));
        return source is null ? [] : Backing_ElementsWithAttribute(source, elementName, attributeName.GetLocalXName(), value);
    }
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : source.Backing_WithAttribute(attributeName, value, comparer);
    }
    ...
    public static IEnumerable<XElement> WithAttribute(this IEnumerable<XElement> source, XmlNames attributeName, string value, IEqualityComparer<string> comparer = null) =>
        (source is null) ? [] : Backing_WithAttribute(source, GetLocalXName(attributeName), value, comparer);
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : source.Backing_WithAttribute(attributeName, value);
    }

    public static IEnumerable<XElement> WithAttribute(this IEnumerable<XElement> source, XmlNames attributeName, bool value) =>
        (source is null) ? [] : Backing_WithAttribute(source, GetLocalXName(attributeName), value);
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_WithAttribute(source, attributeName, value, mode);
    }

    public static IEnumerable<XElement> WithAttribute(this IEnumerable<XElement> source, XmlNames attributeName, DateTime value,
            XmlDateTimeSerializationMode mode = XmlDateTimeSerializationMode.RoundtripKind) =>
        (source is null) ? [] : Backing_WithAttribute(source, GetLocalXName(attributeName), value, mode);
    ...
    {
        if (attributeName is null) throw new ArgumentNullException(nameof(attributeName));
        return source is null ? [] : Backing_WithAttribute(source, attributeName, value);
    }
    ...
    public static IEnumerable<XElement> WithAttribute(this IEnumerable<XElement> source, XName attributeName, double value) =>
        (source is null) ? [] : Backing_WithAttribute(source, attributeName ?? throw new ArgumentNullException(nameof(attributeName)), value);
