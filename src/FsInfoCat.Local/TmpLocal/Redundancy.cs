...
namespace FsInfoCat.Local.Model
{
    ...
    public class Redundancy : LocalDbEntity, IHasMembershipKeyReference<RedundantSet, DbFile>, ILocalRedundancy, IEquatable<Redundancy>
    {
        ...
        /// </summary>
        /// <value>The <see cref="Guid">unique identifier</see> used as the foreign key that refers to the <see cref="File" /><see cref="M.IFile">entity</see>.</value>
        ...
        /// </summary>
        /// <value>The <see cref="Guid">unique identifier</see> used as the foreign key that refers to the <see cref="M.IRedundantSet">entity</see>.</value>
        /// <remarks>This is also part of this entity's compound primary key.</remarks>
        [Required]
        ...
        M.IFile M.IRedundancy.File { get => File; }

        ILocalRedundantSet ILocalRedundancy.RedundantSet { get => RedundantSet; }

        M.IRedundantSet M.IRedundancy.RedundantSet { get => RedundantSet; }
        ...
        IForeignKeyReference<M.IRedundantSet> IHasMembershipKeyReference<M.IRedundantSet, M.IFile>.Ref1 => _redundantSet;

        IForeignKeyReference<M.IFile> IHasMembershipKeyReference<M.IRedundantSet, M.IFile>.Ref2 => _file;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IRedundancy" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IRedundancy other)
        {
            // TODO: Implement ArePropertiesEqual(M.IRedundancy)
            throw new NotImplementedException();
        }
        ...
        /// Tests whether the current database entity is equal to another.
        /// </summary>
        /// <param name="other">The <see cref="M.IRedundancy" /> to compare to.</param>
        /// <returns><see langword="true" /> if the <paramref name="other"/> entity is equal to the current entity; otherwise, <see langword="false" />.</returns>
        public bool Equals(M.IRedundancy other)
        {
            // TODO: Implement Equals(M.IRedundancy)
            throw new NotImplementedException();
        }
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        protected class RedundantSetReference : ForeignKeyReference<RedundantSet>, IForeignKeyReference<ILocalRedundantSet>, IForeignKeyReference<M.IRedundantSet>
        {
            ...
            M.IRedundantSet IForeignKeyReference<M.IRedundantSet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IRedundantSet>>.Equals(IForeignKeyReference<M.IRedundantSet> other)
            {
                throw new NotImplementedException();
            }
