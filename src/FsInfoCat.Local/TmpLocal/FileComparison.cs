...
namespace FsInfoCat.Local.Model
{
    ...
    public class FileComparison : LocalDbEntity, IHasMembershipKeyReference<DbFile, DbFile>, ILocalComparison, IEquatable<FileComparison>
    {
        ...
        M.IFile M.IComparison.Baseline { get => Baseline; }

        ILocalFile ILocalComparison.Correlative { get => Correlative; }

        M.IFile M.IComparison.Correlative { get => Correlative; }
        ...
        IForeignKeyReference<M.IFile> IHasMembershipKeyReference<M.IFile, M.IFile>.Ref1 => _baseline;

        IForeignKeyReference<M.IFile> IHasMembershipKeyReference<M.IFile, M.IFile>.Ref2 => _correlative;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalComparison other) => ArePropertiesEqual((M.IComparison)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IComparison" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IComparison other) => AreEqual == other.AreEqual &&
        ...
        private bool IsEqualTo(M.IComparison other)
        {
            Monitor.Enter(SyncRoot);
            try
            {
        ...
        public bool Equals(M.IComparison other)
        {
            if (other is null) return false;
            if (other is FileComparison fileComparison) return Equals(fileComparison);
            return IsEqualTo(other);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.IComparison other && IsEqualTo(other);
        }
