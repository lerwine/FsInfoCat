...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class DocumentPropertiesRow : PropertiesRow, ILocalDocumentPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalDocumentPropertiesRow other) => ArePropertiesEqual((M.IDocumentPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IDocumentPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IDocumentPropertiesRow other) => ArePropertiesEqual((M.IDocumentProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IDocumentProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IDocumentProperties other) => _clientID == other.ClientID &&
        ...
        public abstract bool Equals(M.IDocumentPropertiesRow other);

        public abstract bool Equals(M.IDocumentProperties other);
