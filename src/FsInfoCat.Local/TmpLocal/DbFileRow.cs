...
namespace FsInfoCat.Local.Model
{
    ...
    public abstract class DbFileRow : LocalDbEntity, ILocalFileRow
    {
        ...
        [Required]
        public virtual M.FileCorrelationStatus Status { get; set; } = M.FileCorrelationStatus.Dissociated;
        ...
        [Required]
        public virtual M.FileCrawlOptions Options { get; set; } = M.FileCrawlOptions.None;
        ...
        protected virtual bool ArePropertiesEqual([DisallowNull] ILocalFileRow other) => ArePropertiesEqual((M.IFileRow)other) && EqualityComparer<Guid?>.Default.Equals(UpstreamId, other.UpstreamId) && LastSynchronizedOn == other.LastSynchronizedOn;

        /// <summary>
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IFileRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.IFileRow other) => ArePropertiesEqual(other) && CreatedOn == other.CreatedOn &&
