...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class PersonalVolumeTag : ItemTag, IHasMembershipKeyReference<Volume, PersonalTagDefinition>, ILocalPersonalVolumeTag, IEquatable<PersonalVolumeTag>
    {
        ...
        IForeignKeyReference<M.IVolume> IHasMembershipKeyReference<M.IVolume, M.IPersonalTagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.IPersonalTagDefinition> IHasMembershipKeyReference<M.IVolume, M.IPersonalTagDefinition>.Ref2 => _definition;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IPersonalVolumeTag" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IPersonalVolumeTag other)
        {
            // TODO: Implement ArePropertiesEqual(M.IPersonalVolumeTag)
            throw new NotImplementedException();
        }
        ...
        public bool Equals(M.IPersonalVolumeTag other)
        {
            if (other is null) return false;
            if (other is PersonalVolumeTag tag) return Equals(tag);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.IPersonalVolumeTag other && ((other is ILocalPersonalVolumeTag local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other));
        }
