...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISymbolicNameRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.ISymbolicNameRow other)
        {
            // TODO: Implement ArePropertiesEqual(M.ISymbolicNameRow)
            throw new NotImplementedException();
        }
