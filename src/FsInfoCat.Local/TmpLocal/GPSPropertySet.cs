...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        // TODO: Document GPSPropertySet class members
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
            ...
            CancellationToken cancellationToken)
        {
            ...
            M.IGPSProperties currentProperties = await fileDetailProvider.GetGPSPropertiesAsync(cancellationToken);
        ...
        public bool Equals(M.IGPSPropertySet other)
        {
            if (other is null) return false;
            if (other is GPSPropertySet propertySet) return Equals(propertySet);
            if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
