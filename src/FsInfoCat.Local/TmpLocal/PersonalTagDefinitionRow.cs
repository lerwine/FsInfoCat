...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class PersonalTagDefinitionRow : LocalDbEntity, ILocalTagDefinitionRow
    {
        ...
        protected virtual bool ArePropertiesEqual([DisallowNull] ILocalTagDefinitionRow other) => ArePropertiesEqual((M.ITagDefinitionRow)other) && EqualityComparer<Guid?>.Default.Equals(UpstreamId, other.UpstreamId) &&
            LastSynchronizedOn == other.LastSynchronizedOn;

        /// <summary>
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ITagDefinitionRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.ITagDefinitionRow other) => CreatedOn == other.CreatedOn &&
