...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class ImagePropertiesRow : PropertiesRow, ILocalImagePropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalImagePropertiesRow other) => ArePropertiesEqual((M.IImagePropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IImagePropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IImagePropertiesRow other) => ArePropertiesEqual((M.IImageProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IImageProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IImageProperties other) => _compressionText == other.CompressionText &&
        ...
        public abstract bool Equals(M.IImagePropertiesRow other);

        public abstract bool Equals(M.IImageProperties other);
