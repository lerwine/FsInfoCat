...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        IEnumerable<M.ISharedFileTag> M.ISharedTagDefinition.FileTags => FileTags.Cast<M.ISharedFileTag>();
        ...
        IEnumerable<M.ISharedSubdirectoryTag> M.ISharedTagDefinition.SubdirectoryTags => SubdirectoryTags.Cast<M.ISharedSubdirectoryTag>();
        ...
        IEnumerable<M.ISharedVolumeTag> M.ISharedTagDefinition.VolumeTags => VolumeTags.Cast<M.ISharedVolumeTag>();
        ...
        public bool Equals(M.ITagDefinition other)
        {
            if (other is null) return false;
            if (other is SharedTagDefinition tagDefinition) return Equals(tagDefinition);
            if (other is not M.ISharedTagDefinition sharedTag) return false;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.ISharedTagDefinition row && (TryGetId(out Guid id1) ? row.TryGetId(out Guid id2) && id1.Equals(id2) :
