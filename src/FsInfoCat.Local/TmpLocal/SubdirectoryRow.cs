...
namespace FsInfoCat.Local.Model
{
    ...
    public abstract class SubdirectoryRow : LocalDbEntity, ILocalSubdirectoryRow
    {
        ...
        [Required]
        public virtual M.DirectoryCrawlOptions Options { get; set; } = M.DirectoryCrawlOptions.None;
        ...
        [Required]
        public M.DirectoryStatus Status { get; set; } = M.DirectoryStatus.Incomplete;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISubdirectoryRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.ISubdirectoryRow other)
        {
            // TODO: Implement ArePropertiesEqual(M.ISubdirectoryRow)
            throw new NotImplementedException();
        }
