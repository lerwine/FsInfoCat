...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        /// same <see cref="M.IRedundancy.RedundantSet" />
        ...
        /// <summary>
        /// Gets the comparisons where the current file was the <see cref="M.IComparison.Baseline" />.
        /// </summary>
        /// <value>The <see cref="ILocalComparison" /> entities where the current file is the <see cref="M.IComparison.Baseline" />.</value>
        ...
        /// <summary>
        /// Gets the comparisons where the current file was the <see cref="M.IComparison.Correlative" /> being compared to a separate <see cref="M.IComparison.Baseline" /> file.
        /// </summary>
        /// <value>The <see cref="ILocalComparison" /> entities where the current file is the <see cref="M.IComparison.Correlative" />.</value>
        ...
        M.IBinaryPropertySet M.IFile.BinaryProperties { get => BinaryProperties; }
        M.ISubdirectory M.IDbFsItem.Parent { get => Parent; }
        ILocalRedundancy ILocalFile.Redundancy => Redundancy;
        M.IRedundancy M.IFile.Redundancy => Redundancy;
        IEnumerable<ILocalComparison> ILocalFile.BaselineComparisons => BaselineComparisons.Cast<ILocalComparison>();
        IEnumerable<M.IComparison> M.IFile.BaselineComparisons => BaselineComparisons.Cast<M.IComparison>();
        IEnumerable<ILocalComparison> ILocalFile.CorrelativeComparisons => CorrelativeComparisons.Cast<ILocalComparison>();
        IEnumerable<M.IComparison> M.IFile.CorrelativeComparisons => CorrelativeComparisons.Cast<M.IComparison>();
        ...
        M.ISummaryPropertySet M.IFile.SummaryProperties { get => SummaryProperties; }
        M.IDocumentPropertySet M.IFile.DocumentProperties { get => DocumentProperties; }
        M.IAudioPropertySet M.IFile.AudioProperties { get => AudioProperties; }
        M.IDRMPropertySet M.IFile.DRMProperties { get => DRMProperties; }
        M.IGPSPropertySet M.IFile.GPSProperties { get => GPSProperties; }
        M.IImagePropertySet M.IFile.ImageProperties { get => ImageProperties; }
        M.IMediaPropertySet M.IFile.MediaProperties { get => MediaProperties; }
        M.IMusicPropertySet M.IFile.MusicProperties { get => MusicProperties; }
        M.IPhotoPropertySet M.IFile.PhotoProperties { get => PhotoProperties; }
        M.IRecordedTVPropertySet M.IFile.RecordedTVProperties { get => RecordedTVProperties; }
        M.IVideoPropertySet M.IFile.VideoProperties { get => VideoProperties; }
        ...
        IEnumerable<M.IFileAccessError> M.IFile.AccessErrors => AccessErrors.Cast<ILocalFileAccessError>();
        IEnumerable<M.IAccessError> M.IDbFsItem.AccessErrors => AccessErrors.Cast<M.IAccessError>();
        ...
        IEnumerable<M.IPersonalFileTag> M.IFile.PersonalTags => SharedTags.Cast<M.IPersonalFileTag>();
        IEnumerable<M.IPersonalTag> M.IDbFsItem.PersonalTags => SharedTags.Cast<M.IPersonalTag>();
        ...
        IEnumerable<M.ISharedFileTag> M.IFile.SharedTags => SharedTags.Cast<M.ISharedFileTag>();
        IEnumerable<M.ISharedTag> M.IDbFsItem.SharedTags => SharedTags.Cast<M.ISharedTag>();
        ...
        public static async Task<bool> DeleteAsync([DisallowNull] DbFile target, [DisallowNull] LocalDbContext dbContext, [DisallowNull] CancellationToken cancellationToken, ItemDeletionOption deletionOption = ItemDeletionOption.Default)
        {
            ...
            switch (deletionOption)
            {
                case ItemDeletionOption.Default:
                    if (target.Options.HasFlag(M.FileCrawlOptions.FlaggedForDeletion))
                    {
                        if (target.Status == M.FileCorrelationStatus.Deleted) return false;
                        target.Status = M.FileCorrelationStatus.Deleted;
                        shouldDelete = false;
                    }
                    else
                        shouldDelete = true;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            ...
            if (length != oldBinaryProperties.Length || ((length == 0L) ? !oldBinaryProperties.Hash.HasValue : (entry.State == EntityState.Modified && oldBinaryProperties.Hash.HasValue)))
            {
                ...
                Status = M.FileCorrelationStatus.Dissociated;
            }

            if (Options.HasFlag(M.FileCrawlOptions.Ignore))
            {
                cancellationToken.ThrowIfCancellationRequested();
                if (entry.State == EntityState.Unchanged)
                {
                    if (Status == M.FileCorrelationStatus.Correlated)
                        return entry;
                    Status = M.FileCorrelationStatus.Correlated;
                }
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// Tests whether the current database entity is equal to another.
        /// </summary>
        /// <param name="other">The <see cref="M.IFile" /> to compare to.</param>
        /// <returns><see langword="true" /> if the <paramref name="other"/> entity is equal to the current entity; otherwise, <see langword="false" />.</returns>
        public bool Equals(M.IFile other)
        {
            if (other is null) return false;
            if (other is DbFile dbFile) return Equals(dbFile);
            if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            ...
            if (obj is not M.IFileRow row) return false;
            ...
            if (row is M.IFile file) return ArePropertiesEqual(file);
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        protected class BinaryPropertySetReference : ForeignKeyReference<BinaryPropertySet>, IForeignKeyReference<ILocalBinaryPropertySet>, IForeignKeyReference<M.IBinaryPropertySet>
        {
            ...
            M.IBinaryPropertySet IForeignKeyReference<M.IBinaryPropertySet>.Entity => Entity;
            ...
            bool IEquatable<IForeignKeyReference<M.IBinaryPropertySet>>.Equals(IForeignKeyReference<M.IBinaryPropertySet> other)
            {
                throw new NotImplementedException();
            }
        }

        protected class SummaryPropertySetReference : ForeignKeyReference<SummaryPropertySet>, IForeignKeyReference<ILocalSummaryPropertySet>, IForeignKeyReference<M.ISummaryPropertySet>
        {
            ...
            M.ISummaryPropertySet IForeignKeyReference<M.ISummaryPropertySet>.Entity => Entity;
            ...
            bool IEquatable<IForeignKeyReference<M.ISummaryPropertySet>>.Equals(IForeignKeyReference<M.ISummaryPropertySet> other)
            {
                throw new NotImplementedException();
            }
        }

        protected class DocumentPropertySetReference : ForeignKeyReference<DocumentPropertySet>, IForeignKeyReference<ILocalDocumentPropertySet>, IForeignKeyReference<M.IDocumentPropertySet>
        {
            ...
            M.IDocumentPropertySet IForeignKeyReference<M.IDocumentPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IDocumentPropertySet>>.Equals(IForeignKeyReference<M.IDocumentPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class AudioPropertySetReference : ForeignKeyReference<AudioPropertySet>, IForeignKeyReference<ILocalAudioPropertySet>, IForeignKeyReference<M.IAudioPropertySet>
        {
            ...
            M.IAudioPropertySet IForeignKeyReference<M.IAudioPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IAudioPropertySet>>.Equals(IForeignKeyReference<M.IAudioPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class DRMPropertySetReference : ForeignKeyReference<DRMPropertySet>, IForeignKeyReference<ILocalDRMPropertySet>, IForeignKeyReference<M.IDRMPropertySet>
        {
            ...
            M.IDRMPropertySet IForeignKeyReference<M.IDRMPropertySet>.Entity => Entity;
            ...
            bool IEquatable<IForeignKeyReference<M.IDRMPropertySet>>.Equals(IForeignKeyReference<M.IDRMPropertySet> other)
            {
                throw new NotImplementedException();
            }
        }

        protected class GPSPropertySetReference : ForeignKeyReference<GPSPropertySet>, IForeignKeyReference<ILocalGPSPropertySet>, IForeignKeyReference<M.IGPSPropertySet>
        {
            ...
            M.IGPSPropertySet IForeignKeyReference<M.IGPSPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IGPSPropertySet>>.Equals(IForeignKeyReference<M.IGPSPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class ImagePropertySetReference : ForeignKeyReference<ImagePropertySet>, IForeignKeyReference<ILocalImagePropertySet>, IForeignKeyReference<M.IImagePropertySet>
        {
            ...
            M.IImagePropertySet IForeignKeyReference<M.IImagePropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IImagePropertySet>>.Equals(IForeignKeyReference<M.IImagePropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class MediaPropertySetReference : ForeignKeyReference<MediaPropertySet>, IForeignKeyReference<ILocalMediaPropertySet>, IForeignKeyReference<M.IMediaPropertySet>
        {
            ...
            M.IMediaPropertySet IForeignKeyReference<M.IMediaPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IMediaPropertySet>>.Equals(IForeignKeyReference<M.IMediaPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class MusicPropertySetReference : ForeignKeyReference<MusicPropertySet>, IForeignKeyReference<ILocalMusicPropertySet>, IForeignKeyReference<M.IMusicPropertySet>
        {
            ...
            M.IMusicPropertySet IForeignKeyReference<M.IMusicPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IMusicPropertySet>>.Equals(IForeignKeyReference<M.IMusicPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class PhotoPropertySetReference : ForeignKeyReference<PhotoPropertySet>, IForeignKeyReference<ILocalPhotoPropertySet>, IForeignKeyReference<M.IPhotoPropertySet>
        {
            ...
            M.IPhotoPropertySet IForeignKeyReference<M.IPhotoPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IPhotoPropertySet>>.Equals(IForeignKeyReference<M.IPhotoPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class RecordedTVPropertySetReference : ForeignKeyReference<RecordedTVPropertySet>, IForeignKeyReference<ILocalRecordedTVPropertySet>, IForeignKeyReference<M.IRecordedTVPropertySet>
        {
            ...
            M.IRecordedTVPropertySet IForeignKeyReference<M.IRecordedTVPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IRecordedTVPropertySet>>.Equals(IForeignKeyReference<M.IRecordedTVPropertySet> other)
            {
                throw new NotImplementedException();
            }
        ...
        protected class VideoPropertySetReference : ForeignKeyReference<VideoPropertySet>, IForeignKeyReference<ILocalVideoPropertySet>, IForeignKeyReference<M.IVideoPropertySet>
        {
            ...
            M.IVideoPropertySet IForeignKeyReference<M.IVideoPropertySet>.Entity => Entity;

            bool IEquatable<IForeignKeyReference<M.IVideoPropertySet>>.Equals(IForeignKeyReference<M.IVideoPropertySet> other)
            {
                throw new NotImplementedException();
            }
