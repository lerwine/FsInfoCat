...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalCrawlJobListItem other) => ArePropertiesEqual((M.ICrawlJobListItem)other) && EqualityComparer<Guid?>.Default.Equals(UpstreamId, other.UpstreamId) && LastSynchronizedOn == other.LastSynchronizedOn;

        /// <summary>
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ICrawlJobListItem" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ICrawlJobListItem other) => ArePropertiesEqual((M.ICrawlJobLogRow)other) && ConfigurationId.Equals(other.ConfigurationId);
        ...
        public override bool Equals(ICrawlJob other)
        {
            ...
            if (other is M.ICrawlJobLogRow row)
            {
                ...
                if (row is M.ICrawlJobListItem listItem)
        ...
        public bool Equals(M.ICrawlJobListItem other)
        {
            if (other is null) return false;
            if (other is CrawlJobLogListItem crawlJobLogListItem) return Equals(crawlJobLogListItem);
            ...
            if (other is ILocalCrawlJobListItem localListItem)
                return ArePropertiesEqual(localListItem);
            if (other is M.ICrawlJobListItem listItem)
                return ArePropertiesEqual(listItem);
