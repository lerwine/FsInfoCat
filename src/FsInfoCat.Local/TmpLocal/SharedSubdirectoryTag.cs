...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class SharedSubdirectoryTag : ItemTag, IHasMembershipKeyReference<Subdirectory, SharedTagDefinition>, ILocalSharedSubdirectoryTag, IEquatable<SharedSubdirectoryTag>
    {
        ...
        M.ISharedTagDefinition M.ISharedTag.Definition => Definition;

        ILocalSubdirectory ILocalSubdirectoryTag.Tagged => Tagged;

        M.ISubdirectory M.ISubdirectoryTag.Tagged => Tagged;
        ...
        IForeignKeyReference<M.ISubdirectory> IHasMembershipKeyReference<M.ISubdirectory, M.ISharedTagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.ISharedTagDefinition> IHasMembershipKeyReference<M.ISubdirectory, M.ISharedTagDefinition>.Ref2 => _definition;

        IForeignKeyReference<M.ISubdirectory> IHasMembershipKeyReference<M.ISubdirectory, M.ITagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.ITagDefinition> IHasMembershipKeyReference<M.ISubdirectory, M.ITagDefinition>.Ref2 => _definition;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISharedSubdirectoryTag" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISharedSubdirectoryTag other)
        {
            // TODO: Implement ArePropertiesEqual(M.ISharedSubdirectoryTag)
            throw new NotImplementedException();
        }
        ...
        public bool Equals(M.ISharedSubdirectoryTag other)
        {
            if (other is null) return false;
            if (other is SharedSubdirectoryTag tag) return Equals(tag);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.ISharedSubdirectoryTag other && ((other is ILocalSharedSubdirectoryTag local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other));
        }
