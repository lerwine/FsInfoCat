...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class SharedVolumeTag : ItemTag, IHasMembershipKeyReference<Volume, SharedTagDefinition>, ILocalSharedVolumeTag, IEquatable<SharedVolumeTag>
    {
        ...
        M.IVolume M.IVolumeTag.Tagged => Tagged;
        ...
        IForeignKeyReference<M.IVolume> IHasMembershipKeyReference<M.IVolume, M.ISharedTagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.ISharedTagDefinition> IHasMembershipKeyReference<M.IVolume, M.ISharedTagDefinition>.Ref2 => _definition;

        IForeignKeyReference<M.IVolume> IHasMembershipKeyReference<M.IVolume, M.ITagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.ITagDefinition> IHasMembershipKeyReference<M.IVolume, M.ITagDefinition>.Ref2 => _definition;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISharedVolumeTag" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISharedVolumeTag other)
        {
            // TODO: Implement ArePropertiesEqual(M.ISharedVolumeTag)
            throw new NotImplementedException();
        }
        ...
        public bool Equals(M.ISharedVolumeTag other)
        {
            if (other is null) return false;
            if (other is SharedVolumeTag tag) return Equals(tag);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.ISharedVolumeTag other && ((other is ILocalSharedVolumeTag local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other));
        }
