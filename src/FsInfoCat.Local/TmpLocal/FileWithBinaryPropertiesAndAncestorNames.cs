...
{
    // TODO: Document FileWithBinaryPropertiesAndAncestorNames class
...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        public override bool Equals(M.IFileListItemWithBinaryProperties other)
        {
        ...
        public bool Equals(M.IFileListItemWithBinaryPropertiesAndAncestorNames other)
        {
            if (other is null) return false;
            if (other is FileWithBinaryPropertiesAndAncestorNames listItem) return Equals(listItem);
            if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.IFileListItemWithBinaryProperties bp)
            {
