...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        // TODO: Document PhotoPropertySet class members
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
            ...
            CancellationToken cancellationToken)
        {
            ...
            M.IPhotoProperties currentProperties = await fileDetailProvider.GetPhotoPropertiesAsync(cancellationToken);
        ...
        public bool Equals(M.IPhotoPropertySet other)
        {
            if (other is null) return false;
            if (other is PhotoPropertySet propertySet) return Equals(propertySet);
            if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
            return !other.TryGetId(out _) && (other is ILocalPhotoPropertySet local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other);
        }
