...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class CrawlConfigListItemBase : CrawlConfigurationRow, ILocalCrawlConfigurationListItem
    {
        ...
        public virtual M.VolumeIdentifier VolumeIdentifier { get; set; } = M.VolumeIdentifier.Empty;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ICrawlConfigurationListItem" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ICrawlConfigurationListItem other) => ArePropertiesEqual((M.ICrawlConfigurationRow)other) &&
            VolumeId.Equals(other.VolumeId) &&
            VolumeIdentifier.Equals(other.VolumeIdentifier) &&
            _ancestorNames == other.AncestorNames &&
            _volumeDisplayName == other.VolumeDisplayName &&
        ...
        public abstract bool Equals(M.ICrawlConfigurationListItem other);
    }
