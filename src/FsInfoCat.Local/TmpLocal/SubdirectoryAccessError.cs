...
namespace FsInfoCat.Local.Model
{
    ...
    public class SubdirectoryAccessError : M.DbEntity, ILocalSubdirectoryAccessError, IEquatable<SubdirectoryAccessError>
    {
        #region Fields
        ...
        public M.ErrorCode ErrorCode { get; set; } = M.ErrorCode.Unexpected;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            ...
            if (string.IsNullOrEmpty(name) || (dbContext = serviceScope.ServiceProvider.GetService<LocalDbContext>()) is null)
                return;
            Guid id = Id;
            M.ErrorCode errorCode = ErrorCode;
        ...
        internal static async Task<int> ImportAsync(LocalDbContext dbContext, ILogger<LocalDbContext> logger, Guid subdirectoryId, XElement accessErrorElement)
        {
            ...
            return await new InsertQueryBuilder(nameof(LocalDbContext.SubdirectoryAccessErrors), accessErrorElement, n).AppendGuid(nameof(TargetId), subdirectoryId)
                ...
                .AppendEnum<M.ErrorCode>(nameof(ErrorCode)).AppendDateTime(nameof(CreatedOn)).AppendDateTime(nameof(ModifiedOn)).ExecuteSqlAsync(dbContext.Database);
        }
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalSubdirectoryAccessError other) => ArePropertiesEqual((M.ISubdirectoryAccessError)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISubdirectoryAccessError" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISubdirectoryAccessError other) => ErrorCode == other.ErrorCode &&
        ...
        /// Tests whether the current database entity is equal to another.
        /// </summary>
        /// <param name="other">The <see cref="M.ISubdirectoryAccessError" /> to compare to.</param>
        /// <returns><see langword="true" /> if the <paramref name="other"/> entity is equal to the current entity; otherwise, <see langword="false" />.</returns>
        public bool Equals(M.ISubdirectoryAccessError other)
        {
            if (other is null) return false;
            if (other is SubdirectoryAccessError subdirctoryAccessError) return Equals(subdirctoryAccessError);
            Guid? id = _id;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.ISubdirectoryAccessError accessError)
            {
                Guid? id = _id;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        protected class SubdirectoryReference : ForeignKeyReference<Subdirectory>, IForeignKeyReference<ILocalSubdirectory>, IForeignKeyReference<M.ISubdirectory>, IEquatable<ILocalSubdirectoryAccessError>, IEquatable<M.ISubdirectoryAccessError>
        {
