...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class SubdirectoryAncestorNames : M.ISubdirectoryAncestorName, IEquatable<SubdirectoryAncestorNames>
    {
        ...
        /// </summary>
        /// <param name="other">The other <see cref="M.ISubdirectoryAncestorName" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISubdirectoryAncestorName other)
        {
            // TODO: Implement ArePropertiesEqual(M.ISubdirectoryAncestorName)
        ...
        public bool Equals(M.ISubdirectoryAncestorName other)
        {
