...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        internal static void OnBuildEntity(EntityTypeBuilder<VolumeListItemWithFileSystem> builder) => (builder ?? throw new ArgumentOutOfRangeException(nameof(builder)))
            .ToView(VIEW_NAME_WITH_FILESYSTEM).Property(nameof(Identifier)).HasConversion(M.VolumeIdentifier.Converter);

        /// <summary>
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IVolumeListItemWithFileSystem" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.IVolumeListItemWithFileSystem other) => ArePropertiesEqual((M.IVolumeListItem)other) &&
        ...
        public bool Equals(M.IVolumeListItemWithFileSystem other)
        {
        ...
        public override bool Equals(M.IVolumeListItem other)
        {
            if (other is null) return false;
            ...
            if (other is M.IVolumeListItemWithFileSystem iVolumeListItemWithFileSystem)
            {
            }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.IVolumeListItemWithFileSystem iVolumeListItemWithFileSystem)
            {
            ...
            if (obj is M.IVolumeListItem iVolumeListItem)
            {
            ...
            if (obj is not M.IVolumeRow volumeRow) return false;
