...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class SharedFileTag : ItemTag, IHasMembershipKeyReference<DbFile, SharedTagDefinition>, ILocalSharedFileTag, IEquatable<SharedFileTag>
    {
        ...
        IForeignKeyReference<M.IFile> IHasMembershipKeyReference<M.IFile, M.ISharedTagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.ISharedTagDefinition> IHasMembershipKeyReference<M.IFile, M.ISharedTagDefinition>.Ref2 => _definition;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISharedFileTag" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISharedFileTag other)
        {
            // TODO: Implement ArePropertiesEqual(M.ISharedFileTag)
            throw new NotImplementedException();
        }
        ...
        public bool Equals(M.ISharedFileTag other)
        {
            if (other is null) return false;
            if (other is SharedFileTag tag) return Equals(tag);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.ISharedFileTag other && ((other is ILocalSharedFileTag local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other));
        }
