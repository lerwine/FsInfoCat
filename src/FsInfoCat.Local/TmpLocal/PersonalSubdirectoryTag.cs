...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class PersonalSubdirectoryTag : ItemTag, IHasMembershipKeyReference<Subdirectory, PersonalTagDefinition>, ILocalPersonalSubdirectoryTag, IEquatable<PersonalSubdirectoryTag>
    {
        ...
        IForeignKeyReference<M.ISubdirectory> IHasMembershipKeyReference<M.ISubdirectory, M.IPersonalTagDefinition>.Ref1 => _tagged;

        IForeignKeyReference<M.IPersonalTagDefinition> IHasMembershipKeyReference<M.ISubdirectory, M.IPersonalTagDefinition>.Ref2 => _definition;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IPersonalSubdirectoryTag" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IPersonalSubdirectoryTag other)
        {
            // TODO: Implement ArePropertiesEqual(M.IPersonalSubdirectoryTag)
            throw new NotImplementedException();
        }
        ...
        public bool Equals(M.IPersonalSubdirectoryTag other)
        {
            if (other is null) return false;
            if (other is PersonalSubdirectoryTag tag) return Equals(tag);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is M.IPersonalSubdirectoryTag other && ((other is ILocalPersonalSubdirectoryTag local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other));
        }
