...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class MusicPropertiesRow : PropertiesRow, ILocalMusicPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalMusicPropertiesRow other) => ArePropertiesEqual((M.IMusicPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IMusicPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IMusicPropertiesRow other) => ArePropertiesEqual((M.IMusicProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IMusicProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IMusicProperties other) => _albumArtist == other.AlbumArtist &&
        ...
        public abstract bool Equals(M.IMusicPropertiesRow other);

        public abstract bool Equals(M.IMusicProperties other);
