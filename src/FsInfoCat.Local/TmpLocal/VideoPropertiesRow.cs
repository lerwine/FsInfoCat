...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class VideoPropertiesRow : PropertiesRow, ILocalVideoPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalVideoPropertiesRow other) => ArePropertiesEqual((M.IVideoPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IVideoPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IVideoPropertiesRow other) => ArePropertiesEqual((M.IVideoProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IVideoProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IVideoProperties other) => _compression == other.Compression &&
        ...
        public abstract bool Equals(M.IVideoPropertiesRow other);

        public abstract bool Equals(M.IVideoProperties other);
