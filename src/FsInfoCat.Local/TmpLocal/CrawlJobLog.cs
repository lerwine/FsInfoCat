...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        M.ICrawlConfiguration M.ICrawlJobLog.Configuration => Configuration;
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ICrawlJobLog" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ICrawlJobLog other) => ArePropertiesEqual((M.ICrawlJobLogRow)other) && ConfigurationId.Equals(other?.Configuration.Id ?? Guid.Empty);
        ...
        public bool Equals(M.ICrawlJobLog other)
        {
            if (other is null) return false;
            if (other is CrawlJobLog crawlJobLog) return Equals(crawlJobLog);
            if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
        ...
        public override bool Equals(ICrawlJob other)
        {
            if (other is null) return false;
            if (other is CrawlJobLog crawlJobLog) return Equals(crawlJobLog);
            if (other is M.ICrawlJobLogRow row)
            {
                ...
                if (row is M.ICrawlJobLog jobLog)
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.ICrawlJobLogRow row)
            {
                if (TryGetId(out Guid id)) id.Equals(row.Id);
                if (!row.Id.Equals(Guid.Empty)) return false;
                if (row is ILocalCrawlJobLog localJobLog)
        ...
        protected class CrawlConfigurationReference : ForeignKeyReference<CrawlConfiguration>, IForeignKeyReference<ILocalCrawlConfiguration>, IForeignKeyReference<M.ICrawlConfiguration>
        {
            ...
            M.ICrawlConfiguration IForeignKeyReference<M.ICrawlConfiguration>.Entity => Entity;
            ...
            bool IEquatable<IForeignKeyReference<M.ICrawlConfiguration>>.Equals(IForeignKeyReference<M.ICrawlConfiguration> other)
            {
                throw new NotImplementedException();
            }
        }
