...
{
    // TODO: Document RedundantSetListItem class
...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalRedundantSetListItem other) => ArePropertiesEqual((ILocalRedundantSetRow)other) && Length == other.Length && EqualityComparer<M.MD5Hash?>.Default.Equals(Hash, other.Hash);

        /// <summary>
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IRedundantSetListItem" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IRedundantSetListItem other) => ArePropertiesEqual((M.IRedundantSetRow)other) && Length == other.Length && EqualityComparer<M.MD5Hash?>.Default.Equals(Hash, other.Hash);

        public bool Equals(RedundantSetListItem other) => other is not null && (ReferenceEquals(this, other) ||
            (TryGetId(out Guid id) ? other.TryGetId(out Guid id2) && id.Equals(id2) : !other.TryGetId(out _) && ArePropertiesEqual(other)));

        public bool Equals(M.IRedundantSetListItem other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.IRedundantSetListItem other)
            {
                if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
                return !other.TryGetId(out _) && (other is ILocalRedundantSetListItem local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other);
            }
