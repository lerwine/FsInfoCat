...
namespace FsInfoCat.Local.Model
{
    ...
    public class FileAccessError : M.DbEntity, ILocalFileAccessError, IEquatable<FileAccessError>
    {
        #region Fields
        ...
        M.IFile M.IFileAccessError.Target => Target;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalFileAccessError other) => ArePropertiesEqual((M.IFileAccessError)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IFileAccessError" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IFileAccessError other) => ErrorCode == other.ErrorCode &&
        ...
        /// Tests whether the current database entity is equal to another.
        /// </summary>
        /// <param name="other">The <see cref="M.IFileAccessError" /> to compare to.</param>
        /// <returns><see langword="true" /> if the <paramref name="other"/> entity is equal to the current entity; otherwise, <see langword="false" />.</returns>
        public bool Equals(M.IFileAccessError other)
        {
            if (other is null) return false;
            if (other is FileAccessError fileAccessError) return Equals(fileAccessError);
            Guid? id = _id;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.IFileAccessError accessError)
            {
                Guid? id = _id;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        protected class FileReference : ForeignKeyReference<DbFile>, IForeignKeyReference<ILocalFile>, IForeignKeyReference<M.IFile>, IEquatable<ILocalFileAccessError>, IEquatable<M.IFileAccessError>
        {
