...
namespace FsInfoCat.Local.Model
{
    ...
    public class VolumeAccessError : M.DbEntity, ILocalVolumeAccessError, IEquatable<VolumeAccessError>
    {
        #region Fields
        ...
        M.IVolume M.IVolumeAccessError.Target => Target;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        protected virtual bool ArePropertiesEqual([DisallowNull] ILocalVolumeAccessError other) => ArePropertiesEqual((M.IVolumeAccessError)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IVolumeAccessError" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.IVolumeAccessError other) => ErrorCode == other.ErrorCode &&
        ...
        /// Tests whether the current database entity is equal to another.
        /// </summary>
        /// <param name="other">The <see cref="M.IVolumeAccessError" /> to compare to.</param>
        /// <returns><see langword="true" /> if the <paramref name="other"/> entity is equal to the current entity; otherwise, <see langword="false" />.</returns>
        public bool Equals(M.IVolumeAccessError other)
        {
            if (other is null) return false;
            if (other is VolumeAccessError volumeAccessError) return Equals(volumeAccessError);
            Guid? id = _id;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.IVolumeAccessError accessError)
            {
                Guid? id = _id;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        protected class VolumeReference : ForeignKeyReference<Volume>, IForeignKeyReference<ILocalVolume>, IForeignKeyReference<M.IVolume>, IEquatable<ILocalVolumeAccessError>,
            IEquatable<M.IVolumeAccessError>
        {
