...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class SummaryPropertiesRow : PropertiesRow, ILocalSummaryPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalSummaryPropertiesRow other) => ArePropertiesEqual((M.ISummaryPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISummaryPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISummaryPropertiesRow other) => ArePropertiesEqual((M.ISummaryProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ISummaryProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.ISummaryProperties other) => _applicationName == other.ApplicationName &&
        ...
        public abstract bool Equals(M.ISummaryPropertiesRow other);

        public abstract bool Equals(M.ISummaryProperties other);
