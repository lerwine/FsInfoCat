...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class MediaPropertiesRow : PropertiesRow, ILocalMediaPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalMediaPropertiesRow other) => ArePropertiesEqual((M.IMediaPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IMediaPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IMediaPropertiesRow other) => ArePropertiesEqual((M.IMediaProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IMediaProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IMediaProperties other) => _contentDistributor == other.ContentDistributor &&
        ...
        public abstract bool Equals(M.IMediaPropertiesRow other);

        public abstract bool Equals(M.IMediaProperties other);
