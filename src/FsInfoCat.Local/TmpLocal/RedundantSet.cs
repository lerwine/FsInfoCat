...
#pragma warning restore CS0659 // Type overrides Object.Equals(object o) but does not override Object.GetHashCode()
    {
        ...
        M.IBinaryPropertySet M.IRedundantSet.BinaryProperties { get => BinaryProperties; }

        IEnumerable<ILocalRedundancy> ILocalRedundantSet.Redundancies => Redundancies.Cast<ILocalRedundancy>();

        IEnumerable<M.IRedundancy> M.IRedundantSet.Redundancies => Redundancies.Cast<M.IRedundancy>();
        ...
        public bool Equals(M.IRedundantSet other)
        {
            if (other is null) return false;
            if (other is RedundantSet redundantSet) return Equals(redundantSet);
            if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is M.IRedundantSet other)
            {
                if (TryGetId(out Guid id)) return other.TryGetId(out Guid id2) && id.Equals(id2);
                return !other.TryGetId(out _) && (other is ILocalRedundantSet local) ? ArePropertiesEqual(local) : ArePropertiesEqual(other);
            }
        ...
        protected class BinaryPropertiesReference : ForeignKeyReference<BinaryPropertySet>, IForeignKeyReference<ILocalBinaryPropertySet>, IForeignKeyReference<M.IBinaryPropertySet>
        {
