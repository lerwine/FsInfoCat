...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class CrawlJobLogRow : LocalDbEntity, ILocalCrawlJobLogRow
    {
        ...
        public M.CrawlStatus StatusCode { get; set; } = M.CrawlStatus.NotRunning;
        ...
        /// </summary>
        /// <value>
        /// The maximum sub-folder recursion depth, where a value less than <c>1</c> only crawls the root <see cref="M.ISubdirectory" />,
        ...
        protected virtual bool ArePropertiesEqual([DisallowNull] ILocalCrawlJobLogRow other) => ArePropertiesEqual((M.ICrawlJobLogRow)other) && EqualityComparer<Guid?>.Default.Equals(UpstreamId, other.UpstreamId) && LastSynchronizedOn == other.LastSynchronizedOn;

        /// <summary>
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ICrawlJobLogRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.ICrawlJobLogRow other) => ArePropertiesEqual((ICrawlJob)other) && RootPath == other.RootPath && StatusCode == other.StatusCode && CrawlEnd == other.CrawlEnd && CreatedOn == other.CreatedOn && ModifiedOn == other.ModifiedOn;
