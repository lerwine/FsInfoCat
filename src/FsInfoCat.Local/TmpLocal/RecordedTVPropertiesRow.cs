...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class RecordedTVPropertiesRow : PropertiesRow, ILocalRecordedTVPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalRecordedTVPropertiesRow other) => ArePropertiesEqual((M.IRecordedTVPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IRecordedTVPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IRecordedTVPropertiesRow other) => ArePropertiesEqual((M.IRecordedTVProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IRecordedTVProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IRecordedTVProperties other) => _episodeName == other.EpisodeName &&
        ...
        public abstract bool Equals(M.IRecordedTVPropertiesRow other);

        public abstract bool Equals(M.IRecordedTVProperties other);
