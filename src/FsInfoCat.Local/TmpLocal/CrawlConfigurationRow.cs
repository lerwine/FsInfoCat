...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class CrawlConfigurationRow : LocalDbEntity, ILocalCrawlConfigurationRow
    {
        ...
        public M.CrawlStatus StatusValue { get; set; } = M.CrawlStatus.NotRunning;
        ...
        protected virtual bool ArePropertiesEqual([DisallowNull] ILocalCrawlConfigurationRow other) => ArePropertiesEqual((M.ICrawlConfigurationRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.ICrawlConfigurationRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.ICrawlConfigurationRow other) => CreatedOn == other.CreatedOn &&
