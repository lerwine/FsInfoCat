...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public abstract class GPSPropertiesRow : PropertiesRow, ILocalGPSPropertiesRow
    {
        ...
        protected bool ArePropertiesEqual([DisallowNull] ILocalGPSPropertiesRow other) => ArePropertiesEqual((M.IGPSPropertiesRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IGPSPropertiesRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected bool ArePropertiesEqual([DisallowNull] M.IGPSPropertiesRow other) => ArePropertiesEqual((M.IGPSProperties)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IGPSProperties" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.IGPSProperties other) => _areaInformation == other.AreaInformation &&
        ...
        public abstract bool Equals(M.IGPSPropertiesRow other);

        public abstract bool Equals(M.IGPSProperties other);
