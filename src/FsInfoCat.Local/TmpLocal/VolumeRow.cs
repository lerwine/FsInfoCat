...
namespace FsInfoCat.Local.Model
{
    ...
    public abstract class VolumeRow : LocalDbEntity, ILocalVolumeRow
    {
        ...
        [Required(AllowEmptyStrings = false, ErrorMessageResourceName = nameof(FsInfoCat.Properties.Resources.ErrorMessage_IdentifierRequired),
            ErrorMessageResourceType = typeof(FsInfoCat.Properties.Resources))]
        public virtual M.VolumeIdentifier Identifier { get; set; } = M.VolumeIdentifier.Empty;
        ...
        [Required]
        public virtual M.VolumeStatus Status { get; set; } = M.VolumeStatus.Unknown;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        {
            M.VolumeIdentifier identifier = Identifier;
        ...
        protected virtual bool ArePropertiesEqual([DisallowNull] ILocalVolumeRow other) => ArePropertiesEqual((M.IVolumeRow)other) &&
        ...
        /// Checks for equality by comparing property values.
        /// </summary>
        /// <param name="other">The other <see cref="M.IVolumeRow" /> to compare to.</param>
        /// <returns><see langword="true" /> if properties are equal; otherwise, <see langword="false" />.</returns>
        protected virtual bool ArePropertiesEqual([DisallowNull] M.IVolumeRow other) => CreatedOn == other.CreatedOn &&
