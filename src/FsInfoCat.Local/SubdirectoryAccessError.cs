...
namespace FsInfoCat.Local
{
    public class SubdirectoryAccessError : DbEntity, ILocalSubdirectoryAccessError, ISimpleIdentityReference<SubdirectoryAccessError>, IEquatable<SubdirectoryAccessError>
    {
        ...
        private readonly ForeignKeyReference<Subdirectory> _targetNav;
        ...
        public SubdirectoryAccessError() => _targetNav = new(null, SyncRoot);
        ...
        public bool Equals(SubdirectoryAccessError other) => other is not null && (ReferenceEquals(this, other) || (TryGetId(out Guid idX) ? other.TryGetId(out Guid idY) && idX.Equals(idY) :
