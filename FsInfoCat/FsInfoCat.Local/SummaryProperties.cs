...
{
    public class SummaryProperties : LocalDbEntity, ILocalSummaryProperties
    {
        #region Fields

        private readonly IPropertyChangeTracker<Guid> _id;
        private readonly IPropertyChangeTracker<string> _applicationName;
        private readonly IPropertyChangeTracker<string[]> _author;
        ...
        public string[] Author { get => _author.GetValue(); set => _author.SetValue(value); }
        ...
        public SummaryProperties()
        {
            ...
            _author = AddChangeTracker<string[]>(nameof(Author), null);
