...
DROP TABLE IF EXISTS "SummaryProperties";
DROP TABLE IF EXISTS "DocumentProperties";
DROP TABLE IF EXISTS "AudioProperties";
DROP TABLE IF EXISTS "DRMProperties";
DROP TABLE IF EXISTS "GPSProperties";
DROP TABLE IF EXISTS "ImageProperties";
DROP TABLE IF EXISTS "MediaProperties";
DROP TABLE IF EXISTS "MusicProperties";
