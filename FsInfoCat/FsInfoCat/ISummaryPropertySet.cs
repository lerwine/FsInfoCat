namespace FsInfoCat
{
    public interface ISummaryPropertySet : IPropertySet
    {
        /// <summary>
        ...
        string SensitivityText { get; set; }
